...
with st.sidebar:
    ...
    st.write("💡 _Lipophilicity_ represents the compound's preference for lipid phases and over aqueous ones. It plays a major role in a molecule's absorption, distribution within the body, metabolism and excretion (ADME properties), as well as its ability to penetrate biological membranes and barriers. [[5]](https://www.acdlabs.com/wp-content/uploads/download/app/physchem/making_sense.pdf) It is mathemtically defined with the partition coefficient P, the measure of the differential solubility of a compound in two immiscible solvents. *LogP* describes lipophilicity in neutral compounds only, so the scientist should be careful to measure the logP only at a pH where the molecule is in its neutral form and not ionized. [[6]](https://www.acdlabs.com/wp-content/uploads/download/app/physchem/logp_vs_logd.pdf)")
    st.subheader("🤔 How do we interpet LogP values?")
    st.write("💡 Higher logP means higher lipophilicity. A negative logP value indicates that the compound is hydrophilic. A logP of zero indicates the molecule is equally dispersed among the two phases. Based on Pfizer's rule, better known as Lipinski's Rule of 5, a molecule for oral administration should have a logP less than 5. [[5]](https://www.acdlabs.com/wp-content/uploads/download/app/physchem/making_sense.pdf)")
